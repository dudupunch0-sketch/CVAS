...
- `python src/cvas_cli.py model.c --analysis-mode full --clang-arg=-Iinclude -o output.json`: use fast analysis plus non-fatal GCC dump metadata with extra compatible compile flags when needed
